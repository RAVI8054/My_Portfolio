...
function Contact() {
    ...
    async function handleSubmit(e) {
        ...
        emailjs.sendForm(
            'service_iyhgbvz', //service id
            'template_jm0d9zs', //templet id
            formRef.current,
            'hKISl7deaibOX8tjN'
        ).then(() => {
            setStatus('success');
                        ...
                        <div className="space-y-3">
                            {[
                                ...
                                { icon: FiPhone, label: "Phone", value: "8058486203" },
                                {
                                    ...
                                    label: "LinkedIn",
                                    value: (
                                        <a href="https://www.linkedin.com/in/raviverma204" target="_blank" rel="noreferrer" className="underline hover:text-primary transition">
                                            linkedin.com/in/Ravi Kumar
                                        </a>
                                    )
                                }
                            ].map((item, idx) => (
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-between h-full">
                    <div>
                        ...
                        {status === 'success' ? (
                            ...
                            <form ref={formRef} onSubmit={handleSubmit} className="space-y-4 flex flex-col gap-2 h-full justify-between">
                                <input
                                    type="text"
                                    name="user_name"
